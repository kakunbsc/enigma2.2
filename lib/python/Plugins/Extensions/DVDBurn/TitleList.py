...
class TitleList(Screen, HelpableScreen):
	skin = """
		<screen position="90,120" size="560,410" title="DVD Tool" >
		    ...
		    <widget source="key_yellow" render="Label" position="300,3" zPosition="1" size="115,37" font="Regular;18" halign="center" valign="center" backgroundColor="#a08500" transparent="1" />
		    ...
		    <widget name="error_label" position="10,48" size="540,360" zPosition="3" font="Regular;20" />
		    <widget source="titles" render="Listbox" scrollbarMode="showOnDemand" position="10,86" size="540,277">
			<convert type="StaticMultiList" />
		    </widget>
		    <widget source="space_bar" render="Progress" position="10,375" size="540,26" borderWidth="1" backgroundColor="#254f7497" />
		    <widget source="space_label" render="Label" position="40,379" size="480,22" zPosition="2" font="Regular;18" halign="center" transparent="1" foregroundColor="#000000" />
		</screen>"""
