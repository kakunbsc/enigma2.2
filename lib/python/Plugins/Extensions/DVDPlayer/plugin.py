...
class DVDPlayer(Screen, InfoBarBase, InfoBarNotifications, InfoBarSeek, InfoBarPVRState, InfoBarShowHide, HelpableScreen, InfoBarCueSheetSupport):
	...
	<screen name="DVDPlayer" flags="wfNoBorder" position="0,380" size="720,160" title="InfoBar" backgroundColor="transparent" >
		<!-- Background -->
		<ePixmap position="0,0" zPosition="-2" size="720,160" pixmap="750S/info-bg_mp.png" alphatest="off" />
		<ePixmap position="29,40" zPosition="0" size="665,104" pixmap="750S/screws_mp.png" alphatest="on" transparent="1" />
		<!-- colorbuttons -->
		<ePixmap position="48,70" zPosition="0" size="108,13" pixmap="750S/icons/mp_buttons.png" alphatest="on" />
		<!-- Servicename -->
		<ePixmap pixmap="750S/icons/icon_event.png" position="207,78" zPosition="1" size="15,10" alphatest="on" />
		...
		<!-- Audio track info -->
		<ePixmap pixmap="750S/icons/icon_dolby.png" position="540,60" zPosition="1" size="26,16" alphatest="on"/>
		...
		<!-- Subtitle track info -->
		<widget source="session.CurrentService" render="Pixmap" pixmap="750S/icons/icon_txt.png" position="540,83" zPosition="1" size="26,16" alphatest="on" >
		...
		<!-- Angle info -->
		<widget name="anglePix" pixmap="750S/icons/icon_view.png" position="540,106" size="26,16" alphatest="on" />
		...
		<widget source="session.CurrentService" render="PositionGauge" position="300,133" size="270,10" zPosition="2" pointer="750S/position_pointer.png:540,0" transparent="1" >
