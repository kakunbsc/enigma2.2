...
class UpdatePluginMenu(Screen):
	skin = """
		<screen name="UpdatePluginMenu" position="80,130" size="560,330" title="Softwaremanager..." >
			<ePixmap pixmap="750S/border_menu_300.png" position="5,10" zPosition="1" size="300,300" transparent="1" alphatest="on" />
	...
	def __init__(self, session, args = 0):
		...
		if self.menu == 0:
#	ikseong
			self.list.append(("software-update", _("Software update"), _("\nOnline update of your STB software." ) + self.oktext) )
...
#			self.list.append(("software-restore", _("Software restore"), _("\nRestore your Dreambox with a new firmware." ) + self.oktext))
			...
			self.list.append(("system-restore",_("Restore system settings"), _("\nRestore your STB settings." ) + self.oktext))
...
#	ikseong modify message type to TYPE_YESNO
#					self.session.openWithCallback(self.runUpgrade, MessageBox, _("Do you want to update your STB?")+"\n"+_("\nAfter pressing OK, please wait!"))
					self.session.openWithCallback(self.runUpgrade, MessageBox, _("Do you want to update your STB?"), MessageBox.TYPE_YESNO)
...
class IPKGMenu(Screen):
	skin = """
		<screen name="IPKGMenu" position="135,144" size="450,320" title="Select IPKG source......" >
			...
			<ePixmap pixmap="750S/buttons/red.png" position="10,280" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			<widget name="closetext" position="20,290" size="140,21" zPosition="10" font="Regular;21" transparent="1" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,280" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class IPKGSource(Screen):
	skin = """
		<screen name="IPKGSource" position="100,100" size="550,80" title="IPKG source" >
			...
			<ePixmap pixmap="750S/buttons/red.png" position="10,40" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			<widget name="closetext" position="20,50" size="140,21" zPosition="10" font="Regular;21" transparent="1" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,40" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class PacketManager(Screen):
	skin = """
		<screen position="90,80" size="530,420" title="IPKG upgrade..." >
			...
			<ePixmap pixmap="750S/buttons/red.png" position="10,380" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			<widget name="closetext" position="20,390" size="140,21" zPosition="10" font="Regular;21" transparent="1" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,380" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class PluginManager(Screen, DreamInfoHandler):
	...
	skin = """
		<screen position="80,80" size="560,440" title="Plugin manager..." >
			...
			<ePixmap pixmap="750S/buttons/red.png" position="0,370" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/green.png" position="140,370" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/yellow.png" position="280,370" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/blue.png" position="420,370" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class PluginManagerInfo(Screen):
	skin = """
		<screen position="80,80" size="560,450" title="Plugin manager job information..." >
			...
			<ePixmap pixmap="750S/div-h.png" position="0,35" zPosition="10" size="550,2" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/red.png" position="0,410" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/green.png" position="140,410" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class PluginDetails(Screen, DreamInfoHandler):
	skin = """
		<screen name="PluginDetails" position="60,90" size="600,420" title="PluginDetails..." >
			...
			<ePixmap pixmap="750S/buttons/red.png" position="0,380" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/green.png" position="140,380" zPosition="2" size="140,40" transparent="1" alphatest="on" />
...
class UpdatePlugin(Screen):
	skin = """
		<screen position="100,150" size="550,200" title="Software Update..." >
	...
	def __init__(self, session, args = None):
		...
		self.sliderPackages = { "STB-dvb-modules": 1, "enigma2": 2, "tuxbox-image-info": 3 }
...
#	ikseong		
		...
		self.status = Label(_("Updating STB... Please wait"))
...
#		self.ipkg.startCmd(IpkgComponent.CMD_UPDATE)
		...
		self.updateTimer.callback.append(self.doUpdate)
...
#		pipe = popen("/usr/bin/usb_sw_update 0","r")
#		print "result",pipe.read()
		cmd = "/usr/bin/usb_sw_update"
		res = system(cmd)
#		if res == 0:
		res = (res>>8)
...
#		self.activityslider.setValue(0)
		...
		if res == 0:	#	ok
			...
			self.status.setText(_("Update completed."))
		elif res == 1:	
			print "file not found"
			self.status.setText(_("File not found."))
		elif res == 2:
			print "usb stick not found"
			self.status.setText(_("USB stick not found."))
		elif res == 3:
			print "damaged update file(invalid file)"
			self.status.setText(_("Damaged update file (Invalid file)"))
		else:
			print "wrong return value ", res
#
...
#		if not self.ipkg.isRunning():
		if self.packages != 0 and self.error == 0:
			self.session.openWithCallback(self.exitAnswer, MessageBox, _("Update finished.") +" "+_("Do you want to reboot your STB?"))
		else:
			self.close()
