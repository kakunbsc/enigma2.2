...
class CrashlogAutoSubmitConfiguration(Screen, ConfigListScreen):
	...
	skin = """
		<screen name="CrashlogAutoSubmitConfiguration" position="80,80" size="560,400" title="CrashlogAutoSubmit settings..." >
			...
			<ePixmap pixmap="750S/div-h.png" position="0,300" zPosition="10" size="560,2" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/red.png" position="0,360" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<ePixmap pixmap="750S/buttons/green.png" position="140,360" zPosition="2" size="140,40" transparent="1" alphatest="on" />
			...
			<widget name="VKeyButton" pixmap="750S/buttons/button_yellow.png" position="285,370" zPosition="2" size="15,16" transparent="1" alphatest="on" />
			<widget name="VKeyIcon" pixmap="750S/vkey_icon.png" position="300,355" zPosition="10" size="60,48" transparent="1" alphatest="on" />
