...
class CleanupWizard(WizardLanguage, Rc):
	...
	skin = """
		<screen name="CleanupWizard" position="0,0" size="720,576" title="Welcome..." flags="wfNoBorder" >
			...
			<ePixmap pixmap="750S/buttons/button_red.png" position="40,225" zPosition="0" size="15,16" transparent="1" alphatest="on" />
			<widget name="languagetext" position="55,225" size="95,30" font="Regular;18" />
			<widget name="wizard" pixmap="750S/wizard.png" position="40,50" zPosition="10" size="110,174" alphatest="on" />
