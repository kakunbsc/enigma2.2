...
class CIselectMainMenu(Screen):
	skin = """
		<screen position="180,150" size="350,270"  title="CI assignment" >
			...
			<ePixmap position="10,210" size="290,2" pixmap="750S/div-h.png" transparent="1" alphatest="on" />
			<ePixmap pixmap="750S/buttons/red.png" position="10,220" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,220" size="140,40" alphatest="on" />
...
class CIconfigMenu(Screen):
	skin = """
		<screen position="60,80" size="595,436" title="CI assignment" >
			...
			<ePixmap position="10,380" size="575,2" pixmap="750S/div-h.png" transparent="1" alphatest="on" />
			<ePixmap pixmap="750S/buttons/red.png" position="10,390" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/green.png" position="155,390" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/yellow.png" position="300,390" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/blue.png" position="445,390" size="140,40" alphatest="on" />
...
class easyCIconfigMenu(CIconfigMenu):
	skin = """
		<screen position="80,80" size="470,420" title="CI assignment" >
			...
			<ePixmap position="10,360" size="450,2" pixmap="750S/div-h.png" transparent="1" alphatest="on" />
			<ePixmap pixmap="750S/buttons/red.png" position="10,370" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,370" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/yellow.png" position="310,370" size="140,40" alphatest="on" />
...
class CAidSelect(Screen):
	skin = """
		<screen position="210,140" size="310,290"  title="select CAId's" >
			...
			<ePixmap position="10,230" size="290,2" pixmap="750S/div-h.png" transparent="1" alphatest="on" />
			<ePixmap pixmap="750S/buttons/red.png" position="10,240" size="140,40" alphatest="on" />
			<ePixmap pixmap="750S/buttons/green.png" position="160,240" size="140,40" alphatest="on" />
