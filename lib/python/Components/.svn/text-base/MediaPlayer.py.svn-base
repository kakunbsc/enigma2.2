...
PlayIcon = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/ico_mp_play.png"))
PauseIcon = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/ico_mp_pause.png"))
StopIcon = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/ico_mp_stop.png"))
RewindIcon = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/ico_mp_rewind.png"))
ForwardIcon = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/ico_mp_forward.png"))
