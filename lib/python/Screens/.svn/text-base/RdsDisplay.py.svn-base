...
class RassInteractive(Screen):
	def __init__(self, session):
		...
		self.subpage_png = {
			1 : LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/rass_page1.png")),
			2 : LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/rass_page2.png")),
			3 : LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/rass_page3.png")),
			4 : LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/rass_page4.png")) }
