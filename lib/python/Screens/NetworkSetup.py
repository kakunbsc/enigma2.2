...
def InterfaceEntryComponent(index,name,default,active ):
	...
	if num_configured_if >= 2:
		if default is True:
			png = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/buttons/button_blue.png"))
		if default is False:
			png = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/buttons/button_blue_off.png"))
		res.append(MultiContentEntryPixmapAlphaTest(pos=(10, 5), size=(25, 25), png = png))
	if active is True:
		png2 = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/lock_on.png"))
	if active is False:
		png2 = LoadPixmap(resolveFilename(SCOPE_SKIN_IMAGE, "750S/icons/lock_error.png"))
