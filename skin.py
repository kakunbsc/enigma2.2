...
#	ikseong - modify primary skin
config.skin.primary_skin = ConfigText(default = "750S/skin.xml")
...
#	ikseong	add 'sposition' attribute to modify start position		
		elif attrib == 'sposition':
			guiObject.setSPosition(parsePosition(value,scale))
#			
		else:
